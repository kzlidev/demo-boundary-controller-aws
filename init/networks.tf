...
resource "aws_subnet" "public_subnet_1" {
  ...
  tags                    = {
    Name = "${var.friendly_name_prefix}-public-subnet-1"
  }
}
...
resource "aws_subnet" "public_subnet_2" {
  ...
  map_public_ip_on_launch = true
  tags                    = {
    Name = "${var.friendly_name_prefix}-public-subnet-2"
  }
}
...
resource "aws_subnet" "public_subnet_3" {
  ...
  map_public_ip_on_launch = true
  tags                    = {
    Name = "${var.friendly_name_prefix}-public-subnet-3"
  }
}
...
resource "aws_subnet" "private_subnet_1" {
  ...
  availability_zone = var.availability_zones[0]
  tags              = {
    Name = "${var.friendly_name_prefix}-private-subnet-1"
  }
}
...
resource "aws_subnet" "private_subnet_2" {
  ...
  availability_zone = var.availability_zones[1]
  tags              = {
    Name = "${var.friendly_name_prefix}-private-subnet-2"
  }
}
...
resource "aws_subnet" "private_subnet_3" {
  ...
  availability_zone = var.availability_zones[2]
  tags              = {
    Name = "${var.friendly_name_prefix}-private-subnet-3"
  }
}
