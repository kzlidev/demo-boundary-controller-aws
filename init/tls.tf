...
resource "tls_self_signed_cert" "ca_cert" {
  ...
  subject {
    ...
    province            = "Singapore"
    locality            = "Singapore"
    common_name         = "KZ HashiCorp Demo"
    organization        = "LiKZDemoOrg"
    organizational_unit = "LikzDemo Root Certification Authority"
  }
...
resource "tls_cert_request" "cluster_csr" {
  ...
  subject {
    ...
    organization        = "LikzBoundaryDemo"
    organizational_unit = "Boundary Demo"
  }
}
